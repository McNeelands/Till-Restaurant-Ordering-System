...
(function($) {
    ...
    //             $sldr.css('cursor', 'url(assets/tera-slider/slide-right-dark.png), e-resize');
    //             if($('body').hasClass('dark-slide'))
    //                 $sldr.css('cursor', 'url(assets/tera-slider/slide-right.png), e-resize');
    //         } else {
    //            $sldr.css('cursor', 'url(assets/tera-slider/slide-left-dark.png), w-resize');
    //             if($('body').hasClass('dark-slide'))
    //                 $sldr.css('cursor', 'url(assets/tera-slider/slide-left.png), w-resize');
    //         }
    //     }
    // });
